...
IT_data_2005_2008 = IT_data[IT_data['Year'].isin([2005, 2006, 2007, 2008]) ]
...
qualifications_2005_08=IT_data_2005_2008['RequiredQual']
qualifications_2005_08=qualifications_2005_08.tolist()


data_words = list(sent_to_words(qualifications_2005_08))
from nltk.corpus import stopwords
...
pos_tags_qual_2005_08=[]
for q in qualifications_2005_08:
    q_tokenized_2005_08= word_tokenize(q)
    pos_tag_qual_2005_08=nltk.pos_tag(q_tokenized_2005_08)
    pos_tags_qual_2005_08.append(pos_tag_qual_2005_08)

content_list_2005_08=[]
for pos_pairs in pos_tags_qual_2005_08:
    qual_content_2005_08=[]
    for p in pos_pairs:
        if p[1]=='NNP' or p[1]=='NN' or p[1]== 'NNS' or p[1]=='NNPS':
            qual_content_2005_08.append(p[0])
    content_list_2005_08.append(qual_content_2005_08)
    
removestopword_2005_08_list=[]
for l in content_list_2005_08:
    removestopword_2005_08=[]
    for w in l:
        w=w.lower()
        if w not in stop_words:
            removestopword_2005_08.append(w)
    removestopword_2005_08_list.append(removestopword_2005_08)
            

   
# from nltk.stem.porter import *

content_list_filtered_2005_08=[]
for l in removestopword_2005_08_list:
    content_filtered_2005_08=[]
    for w in l:

        w=w.lower()
    # w=lemmatizer.lemmatize(w)
        w=lemmatizer.lemmatize(w)
        content_filtered_2005_08.append(w)
    content_list_filtered_2005_08.append(content_filtered_2005_08)
            
converted_list_2005_08=[]
for l in content_list_filtered_2005_08:
    joined_l=' '.join(l)
    converted_list_2005_08.append(joined_l)

filtered_2005_08=[]
for sent in converted_list_2005_08:
    nums='0123456789'
    puncs='''~`!@$%^&*()-_=:;<>,.?\|'"'''
    sent_filtered=''
    for c in sent:
        ...
        if c in puncs:
            c=''
        sent_filtered+=c
    filtered_2005_08.append(sent_filtered)
data_lemmatized =[]
for i in filtered_2005_08:
  i=i.split()
